                        ...
                        <div class="row sub-ct-container">
                            ...
                            <div class="col-sm-3 col-xs-6 sub-ct-col">
                                <div class="sub-ct-col">
                                    ...
                                    <a href="{!! url('/Cuisine') !!}"><img src="{{ asset(" /img/Restaurant-4.jpg ") }}"/>
                                    </a>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6 sub-ct-col">
                                <div class="sub-ct-col">
                                    ...
                                    <a href="{!! url('/Services') !!}"><img src="{{ asset(" /img/photo2.jpg ") }}"/>
                                    </a>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6 sub-ct-col">
                                <div class="sub-ct-col">
                                    ...
                                    <a href="{!! url('/Gallery') !!}"><img src="{{ asset(" /img/Anh-Duong-hotel.jpg ") }}"/>
                                    </a>
                                </div>
                            </div>
                        </div>
