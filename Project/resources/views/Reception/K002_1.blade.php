			...
			<div class="col-md-8 col-md-offset-2" style="background-color:#c3bfc0;">
               <div class="row">
					<div class="col-md-6 form-inline col-md-offset-3" style="border:1px solid #898989;border-radius:10px;margin-top:50px;margin-bottom:50px;">
						<div class="col-md-10 col-md-offset-1" style="margin-top:20px;"><button type="button" class="btnReceptionist btn-block" value="btnReceiveRoom" name="btnReceiveRoom"  onclick="window.location='{{ url("/K003_2?res_id=") }}'" ><p class="receptionist">Nhận phòng</p></button></div>
						<div class="col-md-10 col-md-offset-1" style="margin-top:20px;"><button type="button" class="btnReceptionist btn-block" value="btnReservation" name="btnReservation" onclick="window.location='{{ url("/K004_4") }}'"  ><p class="receptionist">Đặt phòng khách sạn</p></button></div>
