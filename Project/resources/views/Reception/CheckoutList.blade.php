                ...
                <div class="table-scroll">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{!! $data->date_out !!}</td>
                            <td>{!! $data->status !!}</td>
                            <td><a href="{!! url('/Checkout?') . 'resDetail_id=' .  $data->id .'&res_id=' . $data->reservation_id .'&invoice_id=' . $data->invoice_id  !!}" style="text-decoration:underline;"><b>Trả phòng</b></a></td>
                        </tr>
                        <?php $i++; ?>
                            @endforeach
                        @endif
        ...
        <div class="col-md-10 col-md-offset-1" style="background-color:#c3bfc0;">
            <div class="row">
                <div class="col-md-3 col-md-offset-10" style="margin-top:10px;margin-bottom:10px;">
                    <button id="btnBack" class="btn btn-danger col-md-offset-2" type="button" onclick="window.open('/SeparateGroup','_self')"><b>Quay lại</b></button>
                </div>
            </div>
        </div>
