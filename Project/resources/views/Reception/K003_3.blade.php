            ...
            <div class="col-md-10 col-md-offset-1" style="background-color:#c3bfc0;border-bottom:1px solid #898989;">
                ...
                <div class="col-md-12" style="border: 1px solid #898989;border-radius:10px;margin:5px 0px 20px 0px;">
                    <div class="col-md-6">
                        ...
                        <div class="form-inline" style="margin-top:15px;margin-bottom:20px;">
                    ...
                    <div class="col-md-6" style="border-left:1px solid #898989;">
                        ...
                        <div class="form-inline col-md-offset-1" style="margin-top: 15px;">
                            ...
                            <input id="txtTotalprice" name="txtTotalprice" type="text" class="form-control input-md " size="15" readonly>
...
<script src="{{asset('Scripts/K003/K003_3.js')}}"></script>
</html>